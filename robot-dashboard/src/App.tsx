...
function App() {
  ...
  const VIDEO_STREAM_URL = "http://localhost:8000/api/video"; // <--- NEW VIDEO URL
  ...
  return (
    <div className="dashboard-container">
      ...
      <header className="header">
        <h2 style={{margin:0, letterSpacing: '1px'}}>🤖 SENTINEL CONTROLLER</h2>
      ...
      <div className="main-grid">
        ...
        {/* --- 🔴 LIVE VIDEO SECTION (UPDATED) --- */}
        <div className="primary-view">
          <div className="overlay-text">🔴 LIVE: OPTICAL PTZ</div>
          
          {/* This IMG tag streams directly from your Python backend */}
          <img 
        ...
        <div className="side-stack">
          <div className="secondary-panel">
            ...
            <div style={{color:'#555'}}>Thermal Feed Placeholder</div>
          </div>
          <div className="secondary-panel">
